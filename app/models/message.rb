...
class Message
  ...
  def perform(greeting=nil, team=nil, interval=nil)
    if greeting == "start"
      ...
      message = "_Welcome to help!_\n\n_language I understand:\t'tab-bot: [start|stop|help](required)   [team-name](optional:default=Team1)   [break-interval-in-minutes](optional:default=2)_'\n\nexample: _*'tab-bot: start team-amazing 60'*_\n\nStarts 'tab-bot' for 'team-amazing' with a break-timer of '60 minutes'"
    else
